...
(function() {
  cadigan = {
    ...
    get_meta: function(cb) {
      return this.store.get('meta', cb);
    },
    set_meta: function(new_meta, cb) {
        this.store.save('meta', new_meta, cb)
    },
    get_auth: function(cb) {
        this.store.get('auth', cb)
    },
    set_auth: function(new_auth, cb) {
        this.store.save('auth', new_auth, cb)
    },
